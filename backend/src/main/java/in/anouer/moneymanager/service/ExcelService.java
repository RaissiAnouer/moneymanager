...
public class ExcelService {
    ...
    public void writeIncomesToExel(OutputStream os, List<IncomeDTO> incomes) throws IOException {
        try(Workbook workbook=new XSSFWorkbook()) {
            ...
            IntStream.range(0,incomes.size())
                    .forEach(i->{
                        ...
                        row.createCell(2).setCellValue(income.getIcon() != null ? income.getIcon(): "" );
    ...
    public void writeExpensesToExel(OutputStream os, List<ExpenseDTO> expenses) throws IOException {
        try(Workbook workbook=new XSSFWorkbook()) {
